...
<link rel="stylesheet" type="text/css" href="theme/styles/checkout.css">
<link rel="stylesheet" type="text/css" href="theme/styles/checkout_responsive.css">
@endsection
							...
							<form action="#" id="checkout_form">
								...
								<div class="billing_options">
									<div class="billing_account">
										...
										<label for="checkbox_account"><img src="theme/images/checked.png" alt=""></label>
									...
									<div class="billing_shipping">
										...
										<label for="checkbox_shipping"><img src="theme/images/checked.png" alt=""></label>
					...
					<div class="cart_details">
						...
						<div class="payment_options">
							...
							<div>
								...
								<div class="visa payment_option"><a href="#"><img src="theme/images/visa.jpg" alt=""></a></div>
								<div class="master payment_option"><a href="#"><img src="theme/images/master.jpg" alt=""></a></div>
							</div>
...
<script src="theme/js/checkout_custom.js"></script>
@endsection