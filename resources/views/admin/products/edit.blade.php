                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.products.update', $product->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="content" type="content" class="form-control @error('content') is-invalid @enderror" name="content"  required autocomplete="content">{{ old('content') ?? $product->content }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="text" class="form-control @error('quantity') is-invalid @enderror" name="quantity" required autocomplete="new-quantity" value="{{ old('quantity') ?? $product->quantity }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="price" type="text" class="form-control" name="price" required autocomplete="new-price" value="{{ old('price') ?? $product->price}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="file" class="form-control" name="image" required autocomplete="new-image" value="{{ old('image') ?? $product->image}}">
                            </div>
                        </div>
