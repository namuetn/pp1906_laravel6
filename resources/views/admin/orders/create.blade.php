            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.orders.store') }}">
                        ...
                        <div class="form-group row">
                            <label for="content" class="col-md-4 col-form-label text-md-right">{{ __('Total Price') }}</label>

                            <div class="col-md-6">
                                <textarea id="total_price" type="total_price" class="form-control @error('total_price') is-invalid @enderror" name="total_price"  required autocomplete="total_price">{{ old('total_price') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="new-description" value="{{ old('description') }}">
