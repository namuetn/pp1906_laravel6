                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.orders.update', $order->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="user_id" type="text" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{ old('user_id') ?? $order->user_id}}" required autocomplete="user_id" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="total_price" type="total_price" class="form-control @error('total_price') is-invalid @enderror" name="total_price"  required autocomplete="total_price">{{ old('total_price') ?? $order->total_price }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" name="description" required autocomplete="new-description" value="{{ old('description') ?? $order->description }}">
